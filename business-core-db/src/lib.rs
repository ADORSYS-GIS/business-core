// Re-export cache types from postgres-index-cache
pub use postgres_index_cache::{
    CacheError, CacheResult, HasPrimaryKey, Indexable, IdxModelCache, TransactionAware,
