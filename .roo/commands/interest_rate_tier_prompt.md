Crate a command .roo/commands/interest_rate_tier.md that will use the skill  docs/skills/entity_template/entity_with_index_and_audit_and_maincache.md to generate model and repository code for the entity `InterestRateTier` using the sample code in business-core-db/src/models/product/interest_rate_tier_example.rs .

additional instructions
===
- `InterestRateTier` is auditable, indexable and cachable
