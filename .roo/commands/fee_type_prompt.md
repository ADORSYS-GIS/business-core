Crate a command .roo/commands/fee_type_gl_mapping.md that will use the skill  docs/skills/entity_template/entity_with_index_and_audit_and_maincache.md to generate model and repository code for the entity `FeeTypeGlMapping` using the sample code in business-core-db/src/models/product/fee_type_gl_mapping_example.rs .

additional instructions
===
- `FeeTypeGlMapping` is auditable, indexable and cachable
