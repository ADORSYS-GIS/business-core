...
use business_core_db::models::product::account_gl_mapping::{
    AccountGlMappingIdxModel, AccountGlMappingModel,
};
use business_core_db::repository::product::account_gl_mapping::AccountGlMappingRepository;
...
pub struct AccountGlMappingRepositoryImpl {
    ...
    pub account_gl_mapping_idx_cache: Arc<RwLock<Cache<Uuid, AccountGlMappingIdxModel>>>,
}
...
impl AccountGlMappingRepositoryImpl {
    pub fn new(pool: Arc<PgPool>) -> Self {
        Self {
            ...
            account_gl_mapping_idx_cache: Arc::new(RwLock::new(Cache::new(None))),
        }
    }
}

#[async_trait]
impl Fp for AccountGlMappingRepositoryImpl {}

#[async_trait]
impl AccountGlMappingRepository for AccountGlMappingRepositoryImpl {
